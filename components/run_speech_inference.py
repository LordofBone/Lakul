...
class SpeechInference:
    ...
    def run_stt(self):
        ...
        :return:
        """
        logger.info(f"Started running speech inference, offline_mode: {self.offline_mode}, file: {self.audio_file}")
        ...
        logger.info(f"Completed running speech inference, output: {result}")
